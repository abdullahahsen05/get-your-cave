  ...
  return (
    <main className="min-h-screen bg-background text-on-background px-4 pb-20 pt-24 sm:px-6 sm:pb-24 sm:pt-28 lg:px-8">
      <div className="mx-auto flex max-w-6xl flex-col gap-6 lg:gap-8">
        <div className="overflow-hidden rounded-[32px] border border-outline-variant/60 bg-surface-container-lowest/95 shadow-[0_16px_48px_rgba(17,24,39,0.08)]">
          <div className="grid gap-0 lg:grid-cols-[minmax(0,1fr)_320px]">
            <div className="p-5 sm:p-8 lg:p-10">
              <p className="inline-flex items-center gap-2 rounded-full border border-secondary/20 bg-secondary-container/20 px-4 py-2 font-label-caps text-[11px] uppercase tracking-[0.24em] text-secondary">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
                <Link
                  className="inline-flex min-h-11 items-center justify-center rounded-full bg-secondary px-6 py-3 font-label-caps text-label-caps text-on-secondary transition-opacity hover:bg-[#d9590f] sm:w-auto"
                  href={invoiceId ? `/invoices/${invoiceId}` : "/invoices"}
                >
                  {t("payments.returnToInvoice")}
                </Link>
                <Link
                  className="inline-flex min-h-11 items-center justify-center rounded-full border border-outline-variant/70 px-6 py-3 font-label-caps text-label-caps text-primary transition-colors hover:bg-surface-container-low sm:w-auto"
            ...
            <aside className="border-t border-outline-variant/30 bg-background/55 p-5 sm:p-8 lg:border-l lg:border-t-0 lg:p-8">
              <div className="flex h-full flex-col justify-between gap-6 rounded-[28px] border border-outline-variant/60 bg-surface-container-low px-5 py-6">
                ...
                <div className="rounded-[24px] border border-secondary/15 bg-secondary-container/15 px-4 py-4">
