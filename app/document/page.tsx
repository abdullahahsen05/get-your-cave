      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 space-y-12">
          <section className="bg-surface-container-lowest border border-surface-variant p-6 rounded-lg shadow-[0_4px_20px_rgba(15,61,62,0.04)] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <span className="bg-secondary-container text-on-secondary-container px-6 py-1 rounded-full font-label-caps text-label-caps flex items-center gap-1 w-fit">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <button
                className="group border-2 border-dashed border-outline-variant hover:border-primary bg-surface-container-low transition-colors duration-300 p-12 rounded-lg text-center flex flex-col items-center justify-center gap-4 cursor-pointer"
                type="button"
              >
            ...
            <div className="bg-surface-container-lowest border border-surface-variant rounded-lg overflow-x-auto">
              <table className="w-full min-w-[720px] text-left">
                ...
                <tbody className="divide-y divide-surface-variant font-body-sm text-body-sm">
                  <tr>
                    <td className="px-6 py-6 text-primary font-bold">
                      Passport_Scan_v1.pdf
                    </td>
                    <td className="px-6 py-6">
                      <span className="bg-secondary-container/40 text-on-secondary-container px-4 py-1 rounded-full text-[12px] font-bold">
                        VERIFIED
                      </span>
                    </td>
                    ...
                    <td className="px-6 py-6 text-right space-x-4">
                      ...
                      <button className="text-error hover:underline" type="button">
                        Delete
                      </button>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td className="px-6 py-6 text-primary font-bold">
                      Insurance_Cert_2024.jpg
                    </td>
                    <td className="px-6 py-6">
                      <span className="bg-error-container text-on-error-container px-4 py-1 rounded-full text-[12px] font-bold">
                        REJECTED
                      </span>
                    </td>
                    <td className="px-6 py-6 text-on-surface-variant">
        ...
        <aside className="space-y-12">
          <section className="bg-primary-container text-on-primary p-12 rounded-lg shadow-xl lg:sticky lg:top-[120px]">
            ...
            <button className="w-full bg-white text-primary font-bold py-4 px-12 rounded-full hover:bg-secondary-fixed-dim transition-colors flex items-center justify-center gap-4" type="button">
              Submit for Review
