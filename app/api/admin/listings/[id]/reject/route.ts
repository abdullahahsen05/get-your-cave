...
import { rejectListingForAdmin, requireAdminAccess } from "@/lib/admin";
import { adminListingModerationSchema } from "@/lib/validations/admin";
...
export async function PATCH(
  ...
  const result = await rejectListingForAdmin(id, adminUser.id, parsed.data.reason);
